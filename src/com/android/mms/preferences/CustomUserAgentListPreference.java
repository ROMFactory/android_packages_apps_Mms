...
public class CustomUserAgentListPreference extends ListPreference {
    private Context mContext;
    private String mUserAgent;
    private boolean mDialogShowing;
    private EditText mUserAgentCustom;

    public CustomUserAgentListPreference(Context context) {
        super(context);
        mContext = context;
    }

    public CustomUserAgentListPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
